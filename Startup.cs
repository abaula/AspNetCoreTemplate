...
using AspNetCoreTemplate.WebApi.Filters;
using AspNetCoreTemplate.WebApi.ParameterTransformers;
...
namespace AspNetCoreTemplate.WebApi
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint($"/swagger/v{ApiVersionConst.V1_0}/swagger.json", $"AspNetCoreTemplate API v{ApiVersionConst.V1_0}");
            });
